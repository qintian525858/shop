        ...
        return {
            ...
            link: function(scope, element, attrs, admDtp) {
                ...
                scope.calTypeChanged = function() {
                    ...
                    scope.monthNames = constants.calendars[scope.calType+scope.language].monthsNames;
                    scope.daysNames = constants.calendars[scope.calType+scope.language].daysNames;
    ...
    var ADMdtpDirective = function(ADMdtp, ADMdtpConvertor, ADMdtpFactory, constants, $compile, $timeout) {
        ...
        return {
            ...
            link: function(scope, element, attrs, ngModel) {
				...
				scope.language = scope.option.language;
                scope.monthNames = constants.calendars[scope.calType+scope.language].monthsNames;
                scope.daysNames = constants.calendars[scope.calType+scope.language].daysNames;
